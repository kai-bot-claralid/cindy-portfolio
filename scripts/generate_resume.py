...
EXPERIENCE = [
    ("Digital Content & Publications Coordinator", "UNPHU", "Aug 2025 – Present", "Coordinate websites, applications, digital content and publications for the Research Directorate."),
